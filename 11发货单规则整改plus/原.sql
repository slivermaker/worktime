CREATE TABLE IF NOT EXISTS DWD_SALE_DLY_TMP1 AS(
    AS SELECT * FROM TF_DWD_SALE_DLY WHERE 1=0; 
)

TRUNCATE TABLE DWD_SALE_DLY_TMP1;
-----   将艾瓦兹插入到临时表中   -----
...
and to_char(A.EXPORT_CONFIRM_DATE,'yyyymm') < '202412' AND to_char(A.EXPORT_CONFIRM_DATE,'yyyymm') > '202401';
