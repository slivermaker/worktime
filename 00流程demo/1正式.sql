...
DELETE FROM ADS_SALE_PRODUCT WHERE PERIOD_M = ADD_MONTHS(TRUNC(SYSDATE-1, 'MM'), -1);
INSERT INTO ADS_SALE_PRODUCT (
PERIOD_M,
ORG_NAME1,
...
DELETE FROM  ADS_SALE_PRODUCT where ORG_NAME1 NOT in ('国内销售平台','海外销售平台','工业&电力BG') OR  ORG_NAME1  IS NULL;