...
FROM (
    -- 生产订单业绩数据
    SELECT
        TRUNC(a.PERIOD, 'mm') PERIOD,
        A.PRODUCT_LINE AS PRODUCTION_NAME,
        a.CAPACITY_TYPE,
        C.MONTHLY_CAPACITY, 
        C.MIN_CAPACITY_RATE,
        C.UNIT AS MEASUREMENT_NAME,
        0 WEIGHT_M_SHIP_T,
        0 WEIGHT_M_SHIP_T_LAST,
        0 WEIGHT_M_SHIP_T_SAMEP,
        0 WEIGHT_M_SHIP_TAR_T,
        A.WEIGHT_M_TARGET_T,
        A.WEIGHT_M_ACTUAL_T_UNSAVE AS WEIGHT_M_ACTUAL_T,
        A.WEIGHT_LM_ACTUAL_T_UNSAVE AS WEIGHT_LAST_M_ACTUAL_T,
        A.WEIGHT_SAMEP_M_TARGET_T AS WEIGHT_M_SAMEP_T,
        A.WEIGHT_M_TARGET_T AS WEIGHT_M_TARGET_T_ALL,
        A.WEIGHT_M_ACTUAL_T_SAVE + A.WEIGHT_M_ACTUAL_T_UNSAVE AS WEIGHT_M_ACTUAL_T_ALL,
        A.WEIGHT_LM_ACTUAL_T_SAVE + A.WEIGHT_LM_ACTUAL_T_UNSAVE AS WEIGHT_LAST_M_ACTUAL_T_ALL,
        A.WEIGHT_SAMEP_M_ACTUAL_T_SAVE + A.WEIGHT_SAMEP_M_ACTUAL_T_UNSAVE AS WEIGHT_M_SAMEP_T_ALL,
        C.MONTHLY_CAPACITY * EXTRACT(MONTH FROM ADD_MONTHS(SYSDATE, -1)) ACC_CAPACITY,
        A.WEIGHT_M_ACC_ACTUAL_T_UNSAVE ACC_FINISH,
        A.WEIGHT_SAMEP_MACC_ACT_T_UNSAVE ACC_FINISH_SAMEP,
        CASE
