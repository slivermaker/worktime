...
FROM  MDDWS.DWS_PRODUCT_ORDER_REVENUE A--生产订单业绩汇总表
    ...
    LEFT JOIN
    (
        SELECT PERIOD,CORPORATE_ENTITY_NAME_SN,PRODUCT_SORT1,PRODUCT_SORT2,PRODUCT_SORT3,
        ...
        WHERE SALES_TARGET_TYPE='挑战目标' AND BUSINESS_TYPE='发货'
        GROUP BY PERIOD,CORPORATE_ENTITY_NAME_SN,PRODUCT_SORT1,PRODUCT_SORT2,PRODUCT_SORT3
    )D

    ON A.PERIOD=D.PERIOD AND A.PRODUCT_LINE=D.CORPORATE_ENTITY_NAME_SN
